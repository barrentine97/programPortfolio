...
Execution:
    After compiling, you must run both the server and client separately.
    To execute the server, type './server'
    To execute the client, type './client'
